                            ...
                            <form method="POST" action="/ubah/{{ $t->id }}">
                              ...
                              <div class="mb-3">
                                {{-- <div class="row">
                                  ...
                                  <input class="form-control" data-inputmask="'alias': 'datetime'" data-inputmask-inputformat="dd-mm-yyyy HH:MM:ss" value="{{ date('d-m-Y H:i:s', strtotime($t->deadline)) }}" name="deadline"/>
                                </div>
                                <div class="mb-3">
                                  <label class="form-label">Jenis Tugas</label>
                                  <select class="form-select" multiple="multiple" name="jenisTugas" required>
                                    <option value="1" {{ $t->jenis == '1' ? 'selected' : '' }}>Individu</option>
                                    <option value="2" {{ $t->jenis == '2' ? 'selected' : '' }}>Kelompok</option>
                                  </select>
                                </div>
                                <div class="mb-3">
                                  <label class="form-label" for="formSelectBobot">Tingkat Kesulitan</label>
                                  <select class="form-select" multiple="multiple" name="bobotTugas" required id="formSelectBobot">
                                    <option value="1" {{ $t->bobot== '1' ? 'selected' : '' }}>Sulit</option>
                                    <option value="2" {{ $t->bobot== '2' ? 'selected' : '' }}>Sedang</option>
                                    <option value="3" {{ $t->bobot== '3' ? 'selected' : '' }}>Mudah</option>
                                  </select>
                                </div>
                              </div>
